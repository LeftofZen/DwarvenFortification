...
public abstract class GoapValue
{
	...
	/// </summary>
	//public abstract object? Evaluate(GoapWorldState States);
...
public class GoapConstantValue() : GoapValue
{
	...
	/// </summary>
	//public override object? Evaluate(GoapWorldState States) => Value;
}
...
//	/// </summary>
//	[SetsRequiredMembers]
//	public GoapStateValue(GoapValue State) : this() => this.State = State;
//	/// <summary>
...
//	/// </summary>
//	public override object? Evaluate(GoapWorldState States) => Operation.Operate(States.GetValueOrDefault(State), Operand.Evaluate(States));
//}
///// <summary>
...
//	/// Returns the state value after the operation.
//	/// </summary>
//	public override object? Evaluate(GoapWorldState States) => GetValue();
//}